...
O equipamento está pago. O que resta:
...
|---|---|---|---|---|---|---|
| Jan | 4.340 | 117.180 | −45.114 | −16.000 | −2.500 | **+36.121** |
| Fev | 2.800 | 75.600 | −29.106 | −16.000 | −2.500 | **+15.675** |
| Mar | 1.395 | 37.665 | −14.501 | −10.500 | −1.500 | **+3.521** |
| Abr | 720 | 19.440 | −7.484 | −3.800 | −1.500 | **+1.259** |
| Mai–Ago | fechado | 0 | 0 | 0 | −1.500/mês | **−2.550/mês** |
| Set | 450 | 12.150 | −4.678 | −3.800 | −1.500 | **−2.325** |
| Out | 651 | 17.577 | −6.767 | −3.800 | −1.500 | **+343** |
| Nov | 870 | 23.490 | −9.044 | −3.800 | −1.500 | **+3.251** |
| Dez | 2.294 | 61.938 | −23.846 | −10.500 | −2.500 | **+14.457** |
| **Ano** | **13.520** | **365.040** | −140.540 | −68.200 | −21.000 | **+62.101** |

Os quatro meses fechados custam **R$ 10.200 no ano** — só aluguel e overhead mínimo. É barato o suficiente para não valer a pena forçar a operação no inverno.

### 2.2 Com marca própria (hibernando mai–ago)

| Mês | Clientes | Receita | CMV | Folha | Aluguel | **Lucro** |
|---|---|---|---|---|---|---|
| Jan | 3.906 | 124.992 | −40.622 | −16.000 | −2.500 | **+45.290** |
| Fev | 2.520 | 80.640 | −26.208 | −16.000 | −2.500 | **+21.590** |
| Mar | 1.256 | 40.176 | −13.057 | −10.500 | −1.500 | **+6.468** |
| Abr | 648 | 20.736 | −6.739 | −3.800 | −1.500 | **+2.780** |
| Mai–Ago | fechado | 0 | 0 | 0 | −1.500/mês | **−2.550/mês** |
| Set | 405 | 12.960 | −4.212 | −3.800 | −1.500 | **−1.375** |
| Out | 586 | 18.749 | −6.093 | −3.800 | −1.500 | **+1.719** |
| Nov | 783 | 25.056 | −8.143 | −3.800 | −1.500 | **+5.089** |
| Dez | 2.065 | 66.067 | −21.472 | −10.500 | −2.500 | **+19.303** |
| **Ano** | **12.168** | **389.376** | −126.547 | −68.200 | −21.000 | **+90.665** |

**Menos clientes, mais lucro.** Ticket maior e CMV menor.
...
|---|---|---|---|---|
| 32,5% | 0% (preço de mercado) | R$ 84.003 | R$ 90.665 | R$ 6.662 |
| 34,0% | +5% | R$ 78.527 | R$ 90.665 | R$ 12.138 |
| 35,5% | +9% | R$ 73.052 | R$ 90.665 | R$ 17.613 |
| **38,5%** | **+18%** *(minha estimativa)* | **R$ 62.101** | **R$ 90.665** | **R$ 28.565** |
...
|---|---|---|
| CMV 34,0% (+5%) | R$ 12.138 | **22 meses** |
| CMV 35,5% (+9%) | R$ 17.613 | **15 meses** |
| CMV 38,5% (+18%) | R$ 28.565 | **9 meses** |
| CMV 40,0% (+23%) | R$ 34.040 | **8 meses** |

**Regra:** se o insumo da Degusta sair **mais de 8% acima** do mercado livre, plotar marca própria se paga em menos de uma temporada e meia. Abaixo disso, a decisão deixa de ser financeira e vira de posicionamento.

---

## 4. ⚠️ Onde eu posso estar errado

Sejamos honestos sobre o que está sustentando a vantagem da marca própria.

### 4.1 A maior parte da diferença vem do ticket, não do insumo

Isolando o efeito — **mesmo ticket dos dois lados**:

| Ticket | Degusta (CMV 38,5%) | Marca própria (CMV 32,5%) | Diferença |
|---|---|---|---|
| R$ 27 | R$ 62.101 | R$ 78.527 | R$ 16.427 |
| R$ 30 | R$ 80.505 | R$ 98.757 | R$ 18.252 |
| R$ 32 | R$ 92.775 | R$ 112.244 | R$ 19.469 |

Dos R$ 28,5 mil de vantagem, **R$ 16 mil vêm do insumo e R$ 12 mil do ticket maior**. E o ticket de R$ 32 é **uma aposta minha, não um fato**: pressupõe que você consegue vender a R$ 7,49/100 g num ponto onde a Degusta ancora em R$ 5,99.

**Se você não conseguir sustentar o preço premium, a vantagem cai pela metade.**

### 4.2 Se a Degusta vender a preço de mercado

Com CMV idêntico (32,5% nos dois), a marca própria ganha só **R$ 6.662/ano** — e ainda carrega R$ 22 mil de investimento a mais. Nesse cenário, **a plotagem leva mais de três anos para se pagar** e manter a Degusta é a escolha racional.

### 4.3 A premissa que continua frágil

Tudo parte de **140 clientes/dia em janeiro** — estimativa minha, não medição. As fotos mostram uma rua de pousadas e casas, com paver e grama, não o calçadão de bares.

| Cenário | Cli/dia jan | Degusta | Marca própria |
|---|---|---|---|
| **Pessimista (−35%)** | 91 | **+R$ 1.426** | **+R$ 20.341** |
| Conservador (−15%) | 119 | +R$ 36.161 | +R$ 60.896 |
| Base | 140 | +R$ 62.101 | +R$ 90.665 |
| Otimista (+25%) | 175 | +R$ 103.511 | +R$ 139.216 |
| No teto do ponto | 250 | +R$ 192.729 | +R$ 244.087 |

**Boa notícia:** com o aluguel real, **nenhum dos dois quebra nem no cenário ruim.** Na v2, com aluguel de R$ 29,6 mil, a franquia perdia R$ 42 mil a −35%. Agora empata. O aluguel barato é o que dá segurança a este projeto.

### 4.4 Ponto de equilíbrio

| Caminho | Empata com | Clientes/dia em janeiro |
|---|---|---|
| Degusta · 12 meses | 69% do fluxo base | 96 |
| Degusta · hiberna | 64% | 90 |
| Marca própria · 12 meses | 59% | 82 |
| **Marca própria · hiberna** | **55%** | **77** |
...
Se a temporada estiver perto e a decisão da marca ainda não estiver madura: **abra como Degusta nesta temporada e decida a plotagem no inverno.**

- Custa **R$ 22 mil a menos** para abrir e você abre mais rápido
- Você mede o fluxo real, o ticket real e o preço real do insumo
- Em maio, com dados de verdade, decide com segurança e planta a marca fora de temporada
- **Custo dessa opção: ~R$ 28,5 mil de lucro na temporada 1.** Em troca, tira o risco de plantar uma marca num mercado que você ainda não mediu

Numa praia onde a maioria do público é turista de passagem, **o custo de trocar de marca é baixo** — ninguém volta procurando o logo. Isso torna a opção de adiar mais barata do que seria numa cidade.

### 5.2 O que não muda em nenhum dos caminhos

| Decisão | Por quê |
|---|---|
| **Self-service por peso** | Em janeiro são ~4.000 clientes em 31 dias com 35 m². Bowl montado faz 20/hora; balança faz 60–70 |
| **O deck é o salão** | Os 35 m² são produção e balcão. Ninguém quer sentar dentro numa praia |
| **Abrir a tela para a rua** | Hoje há uma barreira física contra o consumo de impulso, no negócio que mais vive de impulso |
| **Hibernar mai–ago** | Custa R$ 10.200 no ano. Operar nesses meses custa mais |
| **Comprar polpa em agosto** | De setembro a dezembro o preço sobe 15–25% pela entressafra amazônica |
...
### 6.1 Qual é, exatamente, o vínculo com a Degusta?

Sem taxa, sem royalty e sem COF, **você provavelmente não é franqueado — é cliente.** Isso tem consequências:

1. **A marca é registrada no INPI em nome deles.** Usar marca de terceiro sem licença escrita é revogável a qualquer momento, inclusive **no meio da temporada**.
2. **Nenhuma obrigação de suporte.** Não há contrato que os obrigue a te abastecer em janeiro, quando todo mundo quer produto.
3. **Nenhuma exclusividade territorial.** Nada impede outra Degusta abrindo na Ferrugem ou em Garopaba.
4. **Se um dia formalizarem**, aí sim vêm taxa, royalty e COF — e as contas da v2 voltam a valer.

**Peça por escrito**, mesmo que seja um e-mail: autorização de uso da marca, prazo, condições de fornecimento e o que acontece se for encerrado.
...
- **O que está plotado com a marca Degusta?** Balcão, freezers, vitrine, fachada. Plotagem é adesivo — troca barato. Peça peritado no orçamento.
- **Cabe nos 35 m²?** A unidade que quebrou pode ter sido dimensionada para uma loja maior. **Faça o layout antes de fechar o aluguel.**
- **Está tudo funcionando?** "Novinho" parado é diferente de "novinho" testado. Ligue tudo antes da temporada, não durante.
- **Falta alguma coisa?** Balança homologada pelo INMETRO é obrigatória em venda por peso. Pia exclusiva de higienização é exigência da Vigilância.
...
| **Deck sem cobertura na chuva** | Média | Pergolado não protege. Prever toldo ou fechamento lateral retrátil |
| **Vigilância Sanitária em 35 m²** | Média | Pia exclusiva, fluxo sujo/limpo, balança INMETRO. Protocolar junto com o alvará |
...
**Marca e fornecimento**
- [Degusta Açaí — Seja um Franqueado](https://franqueadora.degustaacai.com/)
- [Degusta Açaí inaugura em Navegantes/SC](https://jornalnosbairros.com.br/wp/2024/11/franquia-do-degusta-acai-e-inaugurada-em-navegantes/)
...
- [Franquia Maria Açaí — fábrica em Joinville](https://www.suafranquia.com/franquias/alimentacao-e-food-service/sorvetes/maria-acai/)
